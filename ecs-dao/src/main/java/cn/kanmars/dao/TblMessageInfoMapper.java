...
public interface TblMessageInfoMapper {
     ...
     * 查询单个对象
     */
    public TblMessageInfo select(TblMessageInfo tblMessageInfo);

    /**
     * 查询一个对象列表
     */
    public List<TblMessageInfo> selectList(TblMessageInfo tblMessageInfo);

    /**
     * 新增对象，返回增加的数量
     */
    public int insert(TblMessageInfo tblMessageInfo);

    /**
     * 通过主键修改对象，返回修改的数量，主键不可修改
     */
    public int updateByPrimaryKey(TblMessageInfo tblMessageInfo);

    /**
     * 删除对象，返回删除的数量
     */
    public int delete(TblMessageInfo tblMessageInfo);
     ...
     */
    public int insertBatch(List<HashMap> tblMessageInfo);

    /**
     * 批量更新,如果是mysql数据库，需要在jdbcUrl中设置allowMultiQueries=true参数才可以使用
     * 返回值为第一条更新语句的执行结果，并非所有批量更新的语句总和
     */
    public int updateBatch(List<HashMap> tblMessageInfo);

    /**
     * 根据主键查询单个对象
     */
    public TblMessageInfo selectByPrimaryKey(String opendId);
	...
	public List<HashMap<String,String>> queryMessagebyOpenid(String id);

...
<body>
  ...
  $(function(){
      ...
      function aavv(){
      $('#AmountDetail').datagrid({    
	    url:'<%=request.getContextPath()%>/amountDetail/selectList.do',
	    title:"企业表展示",
	    ...
	    columns:[[    
	        ...
	        {field:'earningMonth',title:'月份收益',width:100},    
	        ...
	        {field:'earningsMoney',title:'收益金额',width:100}, 

...
<form id="addMachine">
      	<table>
      		...
      		<tr>
      			<td>机器名称:</td>
      			<td>
      				<input class="easyui-textbox" type="text" name="machineName"  id="univerName" style="width:180px"> 
      			</td>
      		</tr>
      		<tr>
      			<td>投放位置:</td>
      			<td>
      				<input class="easyui-textbox" type="text" name="adress"   style="width:180px">
      			</td>
      		</tr>
      		<tr>
      			<td>是否使用:</td>
      			<td>
      				<input class="easyui-textbox" type="text" name=isUse  style="width:180px"> 
      			</td>
      		</tr>
      		<tr>
      			<td>单个名额价格:</td>
      		...
      		<tr>
      			<td>总名额:</td>
      			<td>
      				<input  class="easyui-textbox"  type="text" name="totalPlaces"  style="width:180px"> 
      			</td>
      		</tr>
      		<tr>
      			<td>剩余名额:</td>
      			<td>
      				<input class="easyui-textbox" type="text" name="leftPlace"  style="width:180px"> 
      			</td>
      		</tr>
      		 <tr>
      			<td> 已售名额:</td>
      			<td>
      				<input class="easyui-textbox" type="text" name="outSalePlace"  style="width:180px"> 
      			</td>
      		</tr> 
      		 <%-- <tr>
      			<td> 创建时间:</td>
